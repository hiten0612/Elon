...
import kotlinx.android.synthetic.main.fragment_next_question.*
import kotlinx.android.synthetic.main.fragment_start_quiz.*

class NextQuestionFragment : Fragment() {


    lateinit var mainController: DashBoard
    private val completeQuizFragment = CompleteQuizFragment()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mainController.completed_quiz_number.text = "2"
        ...
        btnNext2.setOnClickListener(View.OnClickListener {
            ...
            if (second_radioGroup.checkedRadioButtonId == -1) {
                ...
                requireActivity().supportFragmentManager.beginTransaction()
                    .replace(R.id.fLayout, completeQuizFragment, null).addToBackStack(tag).commit()
            }
        })
        exitQuiz1.setOnClickListener(View.OnClickListener {
